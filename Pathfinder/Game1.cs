...
namespace Pathfinder
{
    ...
    {   
        ...
        public Game1()
        {
            ...
            bot = new aStarBot(10, 20);
            //bot = new DijkstraBot(10,20);
            ...
            for (int x = 0; x < sz; x++)
            {
                for (int y = 0; y < sz; y++)
                {
                    ...
                    if (level.tiles[x, y] == 0)
                    {
                            ...
                            else if (!level.ASTAR.closed[x, y] && level.ASTAR.cost[x, y] < 999999 || !level.DIJKSTRA.closed[x, y] && level.DIJKSTRA.cost[x, y] < 999999)
                            {
